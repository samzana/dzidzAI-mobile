...
final List<GrammarExerciseModel> sentenceConstructionQuestions = [
  ...
  GrammarExerciseModel(
    type: "rewriteSentence",
    instructions: "Fill in the blanks with the correct word: 'where,' 'were,' 'we're,' or 'when.'",
    question: "The artist explained that his inspiration came from a time ______ he visited the rural areas of Zimbabwe, where he experienced the rich cultural heritage firsthand.",
    answer: "When",
  ...
  GrammarExerciseModel(
    type: "rewriteSentence",
    instructions: "Fill in the blanks with the correct word: 'where,' 'were,' 'we’re,' or 'when.'",
    question: "The workshops, which ______ organised to help budding musicians improve their skills, were highly praised by both attendees and instructors.",
    answer: "Were",
