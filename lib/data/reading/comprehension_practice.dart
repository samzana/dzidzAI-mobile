...
List<ComprehensionPracticeModel> comprehensionQuestions = [
  ComprehensionPracticeModel(
    ...
    questions: [
      ComprehensionQuestion(
        question:
            "According to the speaker, what does government regard as its major role in education?",
        paragraphNumber: 1,
      ),
      ComprehensionQuestion(
        question: "What is the nation's greatest resource?",
        paragraphNumber: 1,
      ),
      ComprehensionQuestion(
        question: "What is the nation's greatest resource?",
      ...
      ComprehensionQuestion(
        question: "In your own words, explain the phrase 'man all sectors'.",
        paragraphNumber: 3,
      ),
      ComprehensionQuestion(
        question:
            "Why do most of the youths end up unemployed after graduation?",
        paragraphNumber: 3,
      ),
      ComprehensionQuestion(
        question:
            "What is the difference between political and economic independence?",
        paragraphNumber: 4,
      ),
      ComprehensionQuestion(
        question:
            "According to the speaker, what should be done to prepare our youths adequately for life?",
        paragraphNumber: 4,
      ),
      ComprehensionQuestion(
        question:
            "*Those who have a practical bias require the essential theory and practice that go with it.' What does 'it' refer to?",
        paragraphNumber: 5,
      ),
      ComprehensionQuestion(
        question:
            "How best can learners be assisted to make informed choices on areas of specialisation?",
        paragraphNumber: 6,
      ),
      ComprehensionQuestion(
        question:
            "Which current group of people is being referred to as the future adults of our society?",
        paragraphNumber: 7,
      ),
      ComprehensionQuestion(
        question:
            "According to government, who among the following should play the greatest role in educating the nation: teachers, government, parents, and learners?",
        paragraphNumber: 7,
      ),
      ComprehensionQuestion(
        question:
            "What are the two major educational activities that take place at a school?",
        paragraphNumber: 10,
      ),
      ComprehensionQuestion(
        question:
            "Without referring to an example, explain in your own words, what the speaker considers to be the major obstacle to effective teaching and learning.",
        paragraphNumber: 10,
      ),
    ],
  ),
  ...
  ComprehensionPracticeModel(
    instructions: 'Read the following passage very carefully before you attempt any questions.', 
    passage: [
    ...
    questions: [
      ComprehensionQuestion(
    question: "Give the name of the person telling the story.",
    paragraphNumber: 1,
    ),
    ComprehensionQuestion(
      question: "What lifted the writer from the stool?",
      paragraphNumber: 1,
    ),
    ComprehensionQuestion(
      question: "Give the main reason why the author sweated.",
      paragraphNumber: 2,
    ),
    ComprehensionQuestion(
      question: "Which one word shows that the author was surprised that he was alive and had no injuries?",
      paragraphNumber: 2,
    ),
    ComprehensionQuestion(
      question: "Who do you think was firing the guns?",
      paragraphNumber: 4,
    ),
    ComprehensionQuestion(
    question: "Write a phrase of three words, from this paragraph, which shows that there was total destruction.",
    paragraphNumber: 4,
  ),
  ComprehensionQuestion(
    question: "Why was Lotta singing?",
    paragraphNumber: 5,
  ),
  ComprehensionQuestion(
    question: "Using your own words, explain the meaning of captive audience.",
    paragraphNumber: 5,
  ),
  ComprehensionQuestion(
    question: "According to Winston Churchill, which two aspects of London life were affected by the bombardment?",
    paragraphNumber: 7,
  ),
  ComprehensionQuestion(
    question: "What was the main reason why the author returned from Canada to Balham?",
    paragraphNumber: 8,
  ),
  ComprehensionQuestion(
    question: "What does 'it' refer to in the phrase: 'It stretched a little ...'",
    paragraphNumber: 9,
  ),
  ComprehensionQuestion(
    question: "Why was it unusual for Balham to boast three cinemas, countless pubs, and the Balham Hip?",
    paragraphNumber: 9,
  ),
  ComprehensionQuestion(
    question: "Why did the siren wail?",
    paragraphNumber: 13,
  ),
  ]
  ),
  ...
  ComprehensionPracticeModel(
    ...
    questions: [
      ComprehensionQuestion(
        question: "Why was José distressed?",
        paragraphNumber: 1,
      ),
      ComprehensionQuestion(
        question: "Why was Assassin infuriated?",
        paragraphNumber: 2,
      ),
      ComprehensionQuestion(
        question: "Give a reason to explain why Assassin always moved through grass.",
        paragraphNumber: 3,
      ),
      ComprehensionQuestion(
        question: "'He learned to draw them pursuit ...' In your own words, explain the meaning if 'draw them in pursuit'.",
        paragraphNumber: 3,
      ),
      ComprehensionQuestion(
        question: "Why was the jaguar called Assassin?",
        paragraphNumber: 3,
      ),
      ComprehensionQuestion(
        question: "What gave the author a clue that there was something dead in the area",
        paragraphNumber: 7,
      ),
      ComprehensionQuestion(
        question: "How did collaring the dogs save them from probable destruction?",
        paragraphNumber: 7,
      ), 
      ComprehensionQuestion(
        question: "'... that night, I thought out a plan.' In what to ways were the author's plans in paragraph 8 different from the actual methods he later used to kill Assassin",
        paragraphNumber: 8,
      ), 
      ComprehensionQuestion(
      question: "The writer had three dogs. He coupled them. What is meant by 'He coupled them'?",
      paragraphNumber: 11,
    ),
    ComprehensionQuestion(
      question: " '... Assassin was already gushy' \n What had caused Assassin to be gunshy?",
      paragraphNumber: 16,
    ),
    ComprehensionQuestion(
      question: "Considering the information in the whole passage, give two reasons to explain why it was an advantage for the narrator to face Assassin in the clearing.",
      paragraphNumber: 0, // For whole passage, 0 can represent entire passage
    ),
    ComprehensionQuestion(
      question: "'... from nose to tip' \n Which part of Assassin's body is being referred to by the word 'tip'?",
      paragraphNumber: 22,
    ),
    ]
  )
