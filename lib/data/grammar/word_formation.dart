...
final List<GrammarExerciseModel> wordFormationQuestions = [
  ...
  GrammarExerciseModel(
    ...
    answer: "two, to",
    instructions: "Choose the correct homophones to complete the sentence.",
  ...
  GrammarExerciseModel(
    ...
    options: ["paws", "pores"],
    answer: "paws",
    instructions: "Choose the correct homophone to complete the sentence.",
  ...
  GrammarExerciseModel(
    ...
    answer: "palette",
    instructions: "Choose the correct homophone to complete the sentence.",
    feedback: "The correct homophone is 'palette'. The sentence should read: 'The artist used a brush and palette.'"
  ),
];
